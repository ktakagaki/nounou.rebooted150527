...
class NN {
    ...
    public static final FrameRange frameRange(int start, int endMarker, int step) {
        return new FrameRange(start, endMarker, step, false);
    }
    public static final FrameRange frameRange(int start, int endMarker) {
        return new FrameRange(start, endMarker, 1, false);
    }

    public static final Range range(int start, int endMarker, int step) {
        return new Range.Inclusive(start, endMarker, step);
    }
    public static final Range range(int start, int endMarker) {
