...
object XDataNull extends XDataImmutable{
  override def readPointImpl(segment: Int, channel: Int, frame: Int): Int = 0
  ...
  override val length: Vector[Int] = Vector[Int]()
  override val startTimestamp: Vector[Long] = Vector[Long]()
  override val sampleRate: Double = 1D
  override val channelName: Vector[String] = Vector[String]()
}
