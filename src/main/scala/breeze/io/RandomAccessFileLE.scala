...
class RandomAccessFileLE(file: File, arg0: String = "r")  extends RandomAccessFile(file, arg0) {
  ...
  override val converter: ByteConverter = breeze.io.LittleEndianByteConverter
...
object LittleEndianByteConverter extends ByteConverter  {
  ...
  override def uInt16ToBytes(value: Char): Array[Byte]   = BigEndianByteConverter.uInt16ToBytes(value).reverse
