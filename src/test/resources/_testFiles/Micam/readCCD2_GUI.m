function [sampFreq data3DInput] = readCCD2_GUI(pathName, fileName)
...
% Rmin = numerical value of the minimum the user would like to scale the
%        data to
% Rmax = numerical value of the maximum the user would like to scale the
%        data to
%
% outputs:
...
%
% version history: 
%   readCCD2_GUI: take out IndivScale function from this conversion
%       process
tic 
...
% sampling rate (msec to sec to Hz)
fseek(fid, 284, 'bof');
